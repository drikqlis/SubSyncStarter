...
command = "/snap/bin/subsync --cli --verbose 1 --loglevel 20 --logfile '/home/mateusz/subsync/subsync.log' sync --sub '%s' --ref '%s' --out '%s' --effort 0 --overwrite" % (sub_file, reference_file, sub_new)
